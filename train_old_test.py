    ...
    for epoch in range(0, 1):  # epoch ------------------------------------------------------------------
        ...
        for (imgs,targets, paths, _), (imgs_t, targets_s, paths_s, _) in zip(pbar,target_pbar):  # batch -------------------------------------------------------------
            ...
            with amp.autocast(enabled=cuda):
                ...
                # da_img_loss10 = loss_eval( domain0[0], pred[0], is_source_mark = False)
                # da_img_loss20 = loss_eval( domain0[1], pred[0], is_source_mark = False)
                # da_img_loss30 = loss_eval( domain0[2], pred[0], is_source_mark = False)
...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default= '/home/smtm/qhd/code/code_git/yolov5-6.0_R-yolov3/runs/train/exp231_target_only_foggy_/weights/best.pt', help='initial weights path')
