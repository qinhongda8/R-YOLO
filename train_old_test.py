...
def parse_opt(known=False):
    ...
    parser.add_argument('--weights', type=str, default= '/home/smtm/qhd/code/code_git/yolov5-6.0_R-yolov3/runs/train/exp129_cycle/weights/best.pt', help='initial weights path')
